...
import { Brain, CheckCircle, XCircle, Clock, AlertTriangle, Info, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="p-6">
        {recommendations.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">All systems optimal</p>
            <p className="text-gray-400 text-sm">No AI recommendations at this time</p>
          </div>
        ) : (
                ...
                {expandedRecommendation === recommendation.id && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="space-y-3">
                      <div>
                        <h5 className="font-medium text-gray-900 mb-1">Reasoning</h5>
                      ...
                      {recommendation.alternatives.length > 0 && (
                        <div>
                          <h5 className="font-medium text-gray-900 mb-1">Alternative Options</h5>
